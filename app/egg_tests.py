...
def egg_grad_test_vector(): #section-start
    ...
    print("Begining vector grad optimization test. Loss should go down.")
    optimizer = Adam(model.parameters(), lr=1e-3, weight_decay=1e-8)
    batch_size = 32
...
def egg_grad_test_matrix(): #section-start
    ...
    print("Begining matrix grad optimization test. Loss should go down.")
    #section-end
...
def egg_grad_test_affine(): #section-start
    ...
    #section-start grad decent the model
    #section-start announce we are starting
    print("Begining affine grad optimization test. Loss should go down.")
    #section-end
    #section-start set optimization conditions
    optimizer = Adam(model.parameters(), lr=1e-3, weight_decay=1e-8)
    batch_size = 32
    ...
    #section-end
#section-end
def egg_grad_test_scaleshift(): #section-start
    #section-start define test constants
    num_features = 16
    #section-end
    #section-start make the model
    ...
    #section-end
    #section-start generate true model
    true_model = EggScaleShift(
        num_features=num_features
    )
    #section-end
    #section-start grad decent the model
    #section-start announce we are starting
    print("Begining scaleshift grad optimization test. Loss should go down.")
    #section-end
    #section-start set optimization conditions
    optimizer = Adam(model.parameters(), lr=1e-3, weight_decay=1e-8)
    batch_size = 4
